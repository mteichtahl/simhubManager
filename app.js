...
class PokeyConfigurationEditorController {
  constructor() {
    ...
    this.app.on('window-all-closed', this.onElectronAppWindowsAllClosed.bind(this))
  }
  ...
  onSimhubOpenURLDone(callbackArg, apiData) {
    ...
    documentWindow.webContents.on('dom-ready', function() {
      documentWindow.webContents.send(APP_IPC.IPCMSG_CONFIG_URL_DATA, apiData)
    })
